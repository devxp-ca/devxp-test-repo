...
resource "aws_s3_bucket" "terraform_backend_bucket" {
      bucket = "terraform-state-uo24tb4w9q80pajbwe2zuhlnjshq3gkx0z2z3ixim63ss"
}

resource "aws_instance" "testtwo" {
      ...
      iam_instance_profile = aws_iam_instance_profile.testtwo_iam_role_instance_profile.name
}

resource "aws_eip" "testtwo_eip" {
      instance = aws_instance.testtwo.id
      vpc = true
}

resource "aws_iam_instance_profile" "testtwo_iam_role_instance_profile" {
      name = "testtwo_iam_role_instance_profile"
      role = aws_iam_role.testtwo_iam_role.name
}

resource "aws_iam_role" "testtwo_iam_role" {
      name = "testtwo_iam_role"
