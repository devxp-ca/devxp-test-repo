...
resource "google_compute_instance" "gce-suvr" {
      name = "gce-suvr"
...
resource "google_project_service" "gce-suvr-service" {
...
resource "google_storage_bucket" "storage-bucket-qnnk-xlfy-ezwu-lecf-kweu" {
      name = "storage-bucket-qnnk-xlfy-ezwu-lecf-kweu"
      location = "us-west1"
      project = "devxp-339721"
}
